...
import JWT from "jsonwebtoken"
 ...
 export const registerControllers= async(req,res)=>{
    ...
    try {
        ...
        if (!answer) {
          return res.send({ message: "a hobby or sport is Required for validation" });
        }
        if (!phone) {
...
const hashpasswords= await HashPassward(password)
...
export const forgotPasswordController = async (req, res) => {
  try {
    ...
    const hashed = await HashPassward(newPassword);
